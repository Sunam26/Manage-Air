...
<!-- 
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <?php
                ...
                {
                  print '<li>
                  <a class="nav-link active" href="sortie_input.php">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active "><a href="index.html">Data Input</a></li>
          <li class="breadcrumb-item active">Sortie Input</li>
        </ol>
      </nav><br>
    </div><!-- End Page Title -->
        ...
        <div class="col-lg-6">
          ...
          <div class="card_ste">
            <div class="card-body">
              ...
              <form action="another_dbms.php" method="POST">
                <div class="row mb-3">
                  <label for="inputDate" class="col-sm-2 col-form-label">Date</label>
                  <div class="col-sm-10">
                    <input type="date" class="form-control" name="SORTIE_DATE">
                  </div>
                </div>
                <div class="row mb-3">
                  <label for="inputTime" class="col-sm-2 col-form-label">Time</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="SORTIE_TIME">
                  </div>
                </div>
                <!--<div class="row mb-3">
                  <label class="col-sm-2 col-form-label">Aircraft Name</label>
                  <div class="col-sm-10">
                    <select class="form-select" aria-label="Default select example">
                      <option selected>Select the Name of Aircraft</option>
                      <option value="1">Mig-29</option>
                      <option value="2">F-7</option>
                      <option value="3">K-8W</option>
                    </select>
                  </div>
                </div>-->
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                 <label for="inputEmail" class="col-sm-2 col-form-label">Pilot's BD</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="PILOT_BD">
                  </div>
                </div>
                <div class="row mb-3">
                  <label for="inputNumber" class="col-sm-2 col-form-label">Flying Hour</label>
                  <div class="col-sm-10">
                    <input type="number" class="form-control" name="FLYING_HOUR">
                  </div>
                </div>
                <div class="row mb-3">
                  <label for="inputNumber" class="col-sm-2 col-form-label">Engine Hour</label>
                  <div class="col-sm-10">
                    <input type="number" class="form-control" name="ENGINE_HOUR">
                  </div>
                </div>
                <div class="row mb-3">
                  <label for="inputNumber" class="col-sm-2 col-form-label">Landing</label>
                  <div class="col-sm-10">
                    <input type="number" class="form-control" name="LANDING">
                  </div>
                </div>
                <div class="row mb-3">
                  <label for="inputNumber" class="col-sm-2 col-form-label">Used Vehicle</label>
                  <div class="col-sm-10">
                    <input type="number" class="form-control" name="vehicle">
                  </div>
                </div>
               <!--- <div class="row mb-3">
               ...
               <!-- <div class="row mb-3">
                ...
                <div class="row mb-3">
                  <label for="inputPassword" class="col-sm-2 col-form-label">Discripancies</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" style="height: 100px" name="DISCRIPANCIES"></input>
                  </div>
                </div>
                ...
                <!--<div class="row mb-3">-->
                 ...
                 <!-- <div class="col-sm-10">
                    <button type="submit" class="btn btn-primary bttn">Submit Form</button>
                  </div>
                </div>-->
                <div class="col-sm-12" style="padding-left: 50%; padding-right: 10%;">
  ...
  <footer id="footer" class="footer">
    <div class="copyright">
      &copy; Copyright <strong><span>ManageAir</span></strong>. All Rights Reserved
    </div>
    <div class="credits">
