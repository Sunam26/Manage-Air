...
$qry = oci_parse($conn, "SELECT p_n FROM dual");
   $result=oci_execute($qry);
  // $rows = oci_fetch_all($query, $result);
  $pilot_nmbr = 0;
   echo "ei porjonto ashche<br>";
   while (($rows = oci_fetch_row($qry)) != false) {
    $pilot_nmbr=$rows[0];
  }
...
<!-- 
      ...
      <li class="nav-item">
          ...
          <li class="nav-item">
            ...
            <ul id="tables-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
              <li>
                <a  href="Query.php">
                  <i class="bi bi-circle"></i><span>Queries on DATA</span>
                </a>
              </li>
              <!-- <li>
                <a href="#">
            ...
            <div class="card-body pt-3">
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                  <div style="width: 100%; height:auto; "> <h5 class="card-title">History of Bangladesh Air Force</h5></div>
                  <p class="small fst-italic">Sunt est soluta temporibus accusantium neque nam maiores cumque temporibus. Tempora libero non est unde veniam est qui dolor. Ut sunt iure rerum quae quisquam autem eveniet perspiciatis odit. Fuga sequi sed ea saepe at unde.</p>
                  <p class="small fst-italic">Sunt est soluta temporibus accusantium neque nam maiores cumque temporibus. Tempora libero non est unde veniam est qui dolor. Ut sunt iure rerum quae quisquam autem eveniet perspiciatis odit. Fuga sequi sed ea saepe at unde.</p>

          
                  <!--<div style="width: 30%; height: 100%; float: right;">
                   <img src="assets/img/air.jpg" style="  max-width: 100%; height: 100%">
                  </div>-->
                  <div style="width: 100%; height:auto; "> <h5 class="card-title">Our Aircrafts</h5></div>
                  <p class="small fst-italic">Sunt est soluta temporibus accusantium neque nam maiores cumque temporibus. Tempora libero non est unde veniam est qui dolor. Ut sunt iure rerum quae quisquam autem eveniet perspiciatis odit. Fuga sequi sed ea saepe at unde.</p>
                  <p class="small fst-italic">Sunt est soluta temporibus accusantium neque nam maiores cumque temporibus. Tempora libero non est unde veniam est qui dolor. Ut sunt iure rerum quae quisquam autem eveniet perspiciatis odit. Fuga sequi sed ea saepe at unde.</p>

              
                  <!--<div style="width: 30%;height: auto; float: left;">
                   <img src="assets/img/air.jpg" style="  max-width: 100%; height: auto;">
                  </div>-->
                  <div style="width:100% ;height:auto"> <h5 class="card-title">Management Process</h5></div>
                  <p class="small fst-italic">Sunt est soluta temporibus accusantium neque nam maiores cumque temporibus. Tempora libero non est unde veniam est qui dolor. Ut sunt iure rerum quae quisquam autem eveniet perspiciatis odit. Fuga sequi sed ea saepe at unde.</p>
                  <p class="small fst-italic">Sunt est soluta temporibus accusantium neque nam maiores cumque temporibus. Tempora libero non est unde veniam est qui dolor. Ut sunt iure rerum quae quisquam autem eveniet perspiciatis odit. Fuga sequi sed ea saepe at unde.</p>
                  ...
                  <div style="width: 100%; height:auto;"> <h5 class="card-title">Inspections</h5></div>
                    <p class="small fst-italic">Sunt est soluta temporibus accusantium neque nam maiores cumque temporibus. Tempora libero non est unde veniam est qui dolor. Ut sunt iure rerum quae quisquam autem eveniet perspiciatis odit. Fuga sequi sed ea saepe at unde.</p>
                  ...
                  <div style="width: 100%; height:auto"> <h5 class="card-title">Overall Control</h5></div>
                    <p class="small fst-italic">Sunt est soluta temporibus accusantium neque nam maiores cumque temporibus. Tempora libero non est unde veniam est qui dolor. Ut sunt iure rerum quae quisquam autem eveniet perspiciatis odit. Fuga sequi sed ea saepe at unde.</p>
  ...
  <footer id="footer" class="footer">
    ...
    <div class="credits">
      ...
      Designed by <a href="https://bootstrapmade.com/">CSE-20 DBMS GRP-04</a>
    </div>
  </footer><!-- End Footer -->
