                ...
                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                  ...
                  <?php  
                    if( $_SESSION["which"]=="Pilot")
                    {
                      ...
                      print '<div class="row">
                      <div class="col-lg-3 col-md-4 label">Appointment</div>
                    ...
                    elseif( $_SESSION["which"]=="Staff")
                    {
                      ...
                      print '<div class="row">
                      <div class="col-lg-3 col-md-4 label ">Rank</div>
                      <div class="col-lg-9 col-md-8">'. $STAFF_rank .'</div>
                      </div>';
                      ...
                      print '<div class="row">
                      <div class="col-lg-3 col-md-4 label ">Email</div>
                      <div class="col-lg-9 col-md-8">'. $STAFF_email.'</div>
                      </div>';
