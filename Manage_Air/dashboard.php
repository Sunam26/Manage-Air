...
<head>
  ...
  <title>Dashboard - ManageAir</title>
          ...
          <div class="row">
            ...
            <div class="col-xxl-4 col-md-6">
              <div class="card info-card sales-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Sorties <span>| Today</span></h5>
            ...
            <div class="col-xxl-4 col-md-6">
              <div class="card info-card revenue-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Flying Hour <span>| This Month</span></h5>
            ...
            <div class="col-xxl-4 col-xl-12">
              ...
              <div class="card info-card customers-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Discripencies<span>| This Year</span></h5>
            ...
            <!-- Recent Sales -->
             <div class="col-12">
              <div class="card recent-sales overflow-auto">
                ...
                <div class="card">
            <div class="card-body">
              <h5 class="card-title">Today's State</h5>
              ...
              <table class="table table-bordered">
                <thead>
                  <tr>
                    ...
                    <th scope="col">Serviceability</th>
                ...
                <tbody>
                  <?php
                    $query = "SELECT * FROM AIR_DASHBOARD";
                    $stid = oci_parse($conn,$query);
                    $result = oci_execute($stid);
                    $count = 1;
                    if($result){
                        while ($row = oci_fetch_array($stid, OCI_RETURN_NULLS+OCI_ASSOC)) {
                            print '<tr><th scope="row">' . $count . '</th>';
                            foreach ($row as $item) {
         ...
         <div class="card">
            <div class="filter">
             ...
             <div class="card-body">
              ...
              <div class="activity"><?php include 'recent_act.php';?></div>
